...
class DataTrainingArguments:
    ...
    dataset_path: Optional[str] = field(default=None, metadata={"help": "Local huggingface dataset path"})
    ...
    # learning_rate: float = field(default=5e-5, metadata={"help": "Model Learning rate"})

    def __post_init__(self):
        if self.dataset_name is None and self.train_file is None and self.validation_file is None and self.dataset_path is None:
            raise ValueError("Need either a dataset name, path or a training/validation file.")
        else:
...
def main():
    ...
    # data_args.max_eval_samples = 5000
    # Setup logging
    logging.basicConfig(
    ...
    if data_args.dataset_name is not None:
        ...
        print(f"{'='*15} Datsets: {raw_datasets.keys()}")
    else:
        data_files = {}
        dataset_args = {}
